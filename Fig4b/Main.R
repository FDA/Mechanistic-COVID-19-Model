...
# Intracellular Model ----------------------------------------------------------------------	
	hergmod1<-function(t, state, pars) {
		with(as.list(c(state, pars)),{					
					medium_volume=10^-3 					
					dC_intracellularRDV_total=CL_percell*(C_extracellularRDV_total*F_extracellular)/V_percell - CL_percell*(C_intracellularRDV_total*1)/V_percell - Km*(C_intracellularRDV_total*1)-Knew*C_intracellularRDV_total	# Equation (19) in supplementary doc. 							
					dC_extracellularRDV_total=CL_percell*cell_number*(C_intracellularRDV_total*1)/medium_volume - CL_percell*cell_number*(C_extracellularRDV_total*F_extracellular)/medium_volume # Equation (18) in supplementary doc.
					dcell_number = 0 # Equation (20) in supplementary doc.
					dTP = Km*(C_intracellularRDV_total*1) - Kc*TP # Equation (21) in supplementary doc.			 		
